...
# Set up Gemini API
genai.configure(api_key="AIzaSyB_Y7KG78lMINrVYf9qTZwlb-ydjdxsGRI")  # Replace with your actual Gemini API key
...
def generate_advice(gpa, study_field):
    ...
    # Add bonus points or tips for specific study fields
